...
export default function SidebarButton({ routeID, langID, icon, styling }) {
  ...
  return (
    <div className={`grid grid-cols-3 w-full justify-center items-center hover:bg-custom-hover py-2 ${styling}`}onClick={() => handleClick(routeID)}>
