    ...
    return (
        <div className="mt-24 md:mt-16 relative flex items-center justify-center h-auto ">
            ...
            {data.activities.slice(0, 19).map((activity, index) => {
                let styling = 'absolute lg:px-4 lg:py-2 lg:top-[11%] lg:left-[77.2%]  3xl:top-[14%] 3xl:left-[68.6%]  4xl:top-[14.5%] 4xl:left-[77.6%] bg-card-background text-custom-white 2xl:px-7 2xl:py-5 rounded-full';
